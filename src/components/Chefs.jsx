        ...
        <div className="mt-8 grid grid-cols-1 gap-8 md:mt-16 md:grid-cols-2 md:gap-12 lg:grid-cols-3">
          {masterChefs.map((item, index) => (
            <a
              ...
              className="group relative block bg-black rounded-2xl hover:shadow-2xl"
              target="_blank"
            >
              <img
                alt="Developer"
                src={item.img}
                className="absolute inset-0 h-full w-full object-cover opacity-75 transition-opacity group-hover:opacity-30 rounded-2xl"
              />
